        ...
        <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.sectionText}>
              ELNADY was born from a simple yet powerful vision: to democratize programming education 
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.sectionText}>
              ELNADY is built by a diverse team of passionate individuals who share a common goal: 
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.sectionText}>
              ELNADY is built using modern, cutting-edge technologies to ensure the best possible 
              user experience:
