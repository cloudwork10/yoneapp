...
// @access  Admin
router.get('/roadmaps', requireAdmin, async (req, res) => {
  try {
    const page = parseInt(req.query.page) || 1;
    const limit = parseInt(req.query.limit) || 20;
    const skip = (page - 1) * limit;
...
// @access  Admin
router.get('/cv-templates', requireAdmin, async (req, res) => {
  try {
    const page = parseInt(req.query.page) || 1;
    const limit = parseInt(req.query.limit) || 20;
    const skip = (page - 1) * limit;
...
// @access  Public
router.get('/public/cv-templates', publicContentLimiter, async (req, res) => {
  try {
...
// @access  Public
router.get('/public/articles', publicContentLimiter, async (req, res) => {
  try {
...
// @access  Public
router.get('/public/articles/:id', publicContentLimiter, async (req, res) => {
  try {
...
// @access  Public
router.get('/public/roadmaps', publicContentLimiter, async (req, res) => {
  try {
...
// @access  Public
router.get('/public/roadmaps/:id', publicContentLimiter, async (req, res) => {
  try {
...
// @access  Public
router.get('/public/podcasts', publicContentLimiter, async (req, res) => {
  try {
    const { category, featured } = req.query;
